...
export default function ErrorCard() {
    ...
    return (
        <section className="grid grid-cols-1 lg:grid-cols-5 items-stretch ~bg-white shadow-lg">
            <main id="exception" className={`z-10 ${hasSolutions ? 'lg:col-span-3' : 'col-span-full'}`}>
