                    ...
                    <>
                        ...
                        <div className="flex items-center gap-x-2 text-green-700">
                            ...
                            <span id="ai-message" className="text-xs">
                                This solution was <a className="underline" target="_blank" href="https://flareapp.io/docs/ignition/solutions/ai-powered-solutions">generated by AI</a> and might not be 100% accurate.
                            </span>
                        </div>
                    </>
                )}
