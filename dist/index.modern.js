...
function StackTrace({
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    path: selectedFrame == null ? void 0 : selectedFrame.file,
...
function ErrorCard() {
  ...
  const isLaravelError = (_errorOccurrence$cont = errorOccurrence.context_items.env) == null ? void 0 : _errorOccurrence$cont.find(env => env.name === 'laravel_version');
