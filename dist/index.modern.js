...
function FrameCodeSnippetLine(_ref) {
  ...
  return /*#__PURE__*/React.createElement("span", _extends$1({}, props, {
    ...
    token,
    key
  }))), editorUrl && /*#__PURE__*/React.createElement("a", {
    href: editorUrl,
...
var Highlight = /*@__PURE__*/function (Component) {
  function Highlight() {
    ...
    _defineProperty$2(this, "getThemeDict", function (props) {
    ...
    _defineProperty$2(this, "getLineProps", function (ref) {
      var key = ref.key;
    ...
    _defineProperty$2(this, "getStyleForToken", function (ref) {
      var types = ref.types;
      var empty = ref.empty;
      var typesSize = types.length;
      var themeDict = this$1$1.getThemeDict(this$1$1.props);
    ...
    _defineProperty$2(this, "getTokenProps", function (ref) {
      var key = ref.key;
      var className = ref.className;
      var style = ref.style;
      var token = ref.token;
    ...
    _defineProperty$2(this, "tokenize", function (Prism, code, grammar, language) {
      var env = {
        code: code,
        grammar: grammar,
        language: language,
...
var faAngleDown={prefix:'fas',iconName:'angle-down',icon:[320,512,[],"f107","M143 352.3L7 216.3c-9.4-9.4-9.4-24.6 0-33.9l22.6-22.6c9.4-9.4 24.6-9.4 33.9 0l96.4 96.4 96.4-96.4c9.4-9.4 24.6-9.4 33.9 0l22.6 22.6c9.4 9.4 9.4 24.6 0 33.9l-136 136c-9.2 9.4-24.4 9.4-33.8 0z"]};var faCopy={prefix:'fas',iconName:'copy',icon:[448,512,[],"f0c5","M320 448v40c0 13.255-10.745 24-24 24H24c-13.255 0-24-10.745-24-24V120c0-13.255 10.745-24 24-24h72v296c0 30.879 25.121 56 56 56h168zm0-344V0H152c-13.255 0-24 10.745-24 24v368c0 13.255 10.745 24 24 24h272c13.255 0 24-10.745 24-24V128H344c-13.2 0-24-10.8-24-24zm120.971-31.029L375.029 7.029A24 24 0 0 0 358.059 0H352v96h96v-6.059a24 24 0 0 0-7.029-16.97z"]};
...
function RelaxedFilePath({
  ...
  return /*#__PURE__*/React.createElement("span", {
    ...
    className: `${partClass} font-semibold`
...
function FrameGroup({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, frameGroup.frames.map(frame => /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("li", {
    ...
    className: `px-6 sm:px-10 py-4
                            ${frame.selected ? 'bg-red-500 text-white' : 'border-b ~border-gray-200 hover:~bg-red-500/10'}
                        `,
...
function EditorLink({
  ...
  return /*#__PURE__*/React.createElement("a", {
    ...
    partClass: "group-hover:underline"
  }));
}
