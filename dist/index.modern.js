...
function FrameCodeSnippetLine(_ref) {
  ...
  return /*#__PURE__*/React.createElement("span", _extends$1({}, props, {
    className: `
                block group pl-4 leading-loose hover:~bg-red-500/10
                ${highlight ? ' ~bg-red-500/20' : ''}
            `
  }), editorUrl && /*#__PURE__*/React.createElement("span", {
    className: "z-30 opacity-0 group-hover:opacity-100 sticky left-10 -ml-4 w-0 h-full"
