...
import React__default, { createContext, useState, useEffect, useContext, Component, useMemo, useReducer, useLayoutEffect, useRef, Children } from 'react';
...
var _config = _objectSpread({}, _default$6, initial);
...
function convert$2(createElement, element) {
  ...
  var children = (element.children || []).map(function (child) {
    return convert$2(createElement, child);
  });
...
function FrameCodeSnippetLine(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement("span", _extends$1({}, props, {
    ...
    className: "z-30 opacity-0 group-hover:opacity-100 sticky left-10 -ml-6 w-0 h-full"
    ...
    className: "text-xs",
    icon: faPencilAlt
  }))), line.map((token, key) => /*#__PURE__*/React__default.createElement("span", getTokenProps({
    token,
    key
  }))));
}
...
var negateValue = /*#__PURE__*/Object.defineProperty({
  default: default_1$1
}, '__esModule', {
  value: true
});
...
var configurePlugins = /*#__PURE__*/Object.defineProperty({
  default: default_1
}, '__esModule', {
  value: true
});
...
function buildStyle(chalk, styles) {
  ...
  for (const [styleName, _styles] of Object.entries(enabled)) {
...
const proto = Object.defineProperties(() => {}, _extends$1({}, styles, {
  level: {
    enumerable: true,
...
var log_1 = createCommonjsModule(function (module, exports) {
  ...
  var _default = {
    info(key, messages) {
      log(_chalk.default.bold.cyan('info'), ...(Array.isArray(key) ? [key] : [messages, key]));
    },

    warn(key, messages) {
      log(_chalk.default.bold.yellow('warn'), ...(Array.isArray(key) ? [key] : [messages, key]));
    },

    risk(key, messages) {
      log(_chalk.default.bold.magenta('risk'), ...(Array.isArray(key) ? [key] : [messages, key]));
    }
...
var colors$2 = createCommonjsModule(function (module, exports) {
...
var defaults_1 = /*#__PURE__*/Object.defineProperty({
  defaults: defaults_2
}, '__esModule', {
  value: true
});
...
var toPath_1 = /*#__PURE__*/Object.defineProperty({
  toPath: toPath_2
}, '__esModule', {
  value: true
});

var normalizeConfig_2 = normalizeConfig;
...
function normalizeConfig(config) {
  ...
  */
  ...
  if (!valid) {
    _log.default.warn('purge-deprecation', ['The `purge`/`content` options have changed in Tailwind CSS v3.0.', 'Update your configuration file to eliminate this warning.']);
  ...
  if (typeof config.prefix === 'function') {
    _log.default.warn('prefix-function', ['As of Tailwind CSS v3.0, `prefix` cannot be a function.', 'Update `prefix` in your configuration to be a string to eliminate this warning.']);
  ...
  for (let file of config.content.files) {
    if (typeof file === 'string' && /{([^,]*?)}/g.test(file)) {
      _log.default.warn('invalid-glob-braces', [`The glob pattern ${(_log).dim(file)} in your config is invalid.`, `    Update it to ${(_log).dim(file.replace(/{([^,]*?)}/g, '$1'))} to silence this warning.`]);
...
var normalizeConfig_1 = /*#__PURE__*/Object.defineProperty({
  normalizeConfig: normalizeConfig_2
}, '__esModule', {
  value: true
});

var _default$3 = isPlainObject;
...
var cloneDeep_1 = /*#__PURE__*/Object.defineProperty({
  cloneDeep: cloneDeep_2
}, '__esModule', {
  value: true
});

const _excluded$5 = ["extend"];

var _default$2 = resolveConfig$1;

var _negateValue = _interopRequireDefault$2(negateValue);

var _corePluginList = _interopRequireDefault$2(corePluginList);

var _configurePlugins = _interopRequireDefault$2(configurePlugins);

var _defaultConfigStub = _interopRequireDefault$2(defaultConfig_stub);

var _colors = _interopRequireDefault$2(colors$2);

var _isPlainObject = _interopRequireDefault$2(isPlainObject_1);
...
const configUtils = {
  ...
  breakpoints(screens) {
    return Object.keys(screens).filter(key => typeof screens[key] === 'string').reduce((breakpoints, key) => _extends$1({}, breakpoints, {
...
function mergeThemes(themes) {
  return _extends$1({}, themes.reduce((merged, theme) => (defaults_1).defaults(merged, theme), {}), {
...
function mergeExtensions(_ref) {
  let {
    extend
  } = _ref,
      theme = _objectWithoutPropertiesLoose$1(_ref, _excluded$5);
...
function resolveFunctionKeys(object) {
  const resolvePath = (key, defaultValue) => {
    const path = (toPath_1).toPath(key);
    let index = 0;
    let val = object;
    ...
    if ((_isPlainObject).default(val)) {
      return (cloneDeep_1).cloneDeep(val);
    }
...
function resolveConfig$1(configs) {
  ...
  var ref, ref2;
  return (normalizeConfig_1).normalizeConfig((defaults_1).defaults({
...
var resolveConfig_1$2 = /*#__PURE__*/Object.defineProperty({
  default: _default$2
}, '__esModule', {
  value: true
});
...
function getAllConfigs(config) {
  ...
  const features = {};
  const experimentals = Object.keys(features).filter(feature => (featureFlags_1).flagEnabled(config, feature)).map(feature => features[feature]);
  return [config, ...experimentals, ...configs];
}

var getAllConfigs_1 = /*#__PURE__*/Object.defineProperty({
  default: _default$1
}, '__esModule', {
  value: true
});
...
var _resolveConfig = _interopRequireDefault(resolveConfig_1$2);

var _getAllConfigs = _interopRequireDefault(getAllConfigs_1);
...
function resolveConfig(...configs) {
  ...
  return (_resolveConfig).default([...configs, ...defaultConfigs]);
}

var resolveConfig_1$1 = /*#__PURE__*/Object.defineProperty({
  default: _default
}, '__esModule', {
  value: true
});

var resolveConfig_1 = (resolveConfig_1$1.__esModule ? resolveConfig_1$1 : {
  default: resolveConfig_1$1
}).default;

var defaultConfig = createCommonjsModule(function (module, exports) {
  ...
  var _defaultConfigStub = _interopRequireDefault(defaultConfig_stub);
  ...
  var _default = (cloneDeep_1).cloneDeep(_defaultConfigStub.default);

  exports.default = _default;
});

var defaultConfig_1 = (defaultConfig.__esModule ? defaultConfig : {
...
} = resolveConfig_1(defaultConfig_1); // Converted automatically using ./tools/themeFromVsCode

var darkTheme = {
  plain: {
    color: colors$1.gray[100],
    backgroundColor: colors$1.gray[800]
  },
  styles: [{
    types: ["prolog"],
    style: {
      color: colors$1.indigo[600]
    }
  }, {
    types: ["comment"],
    style: {
      color: colors$1.gray[500]
    }
  }, {
    types: ["builtin", "changed", "keyword", "interpolation-punctuation"],
    style: {
      color: colors$1.blue[300]
    }
  }, {
    types: ["number", "inserted"],
    style: {
      color: colors$1.emerald[300]
    }
  }, {
    types: ["constant"],
    style: {
      color: colors$1.violet[400]
    }
  }, {
    types: ["attr-name", "variable"],
    style: {
      color: colors$1.blue[200]
    }
  }, {
    types: ["deleted", "string", "attr-value", "template-punctuation"],
    style: {
      color: colors$1.red[300]
    }
  }, {
    types: ["selector"],
    style: {
      color: colors$1.yellow[200]
    }
  }, {
    // Fix tag color
    types: ["tag"],
    style: {
      color: colors$1.emerald[400]
    }
  }, {
    ...
    languages: ["markup"],
    style: {
      color: colors$1.blue[400]
    }
  }, {
    types: ["punctuation", "operator"],
    style: {
      color: colors$1.gray[300]
    }
  }, {
    ...
    types: ["function"],
    style: {
      color: colors$1.yellow[100]
    }
  }, {
    types: ["class-name"],
    style: {
      color: colors$1.violet[300]
    }
  }, {
    types: ["char"],
    style: {
      color: colors$1.red[200]
    }
  }]
};
...
function FrameCodeSnippet({
  ...
  return /*#__PURE__*/React__default.createElement("main", {
  ...
  }, /*#__PURE__*/React__default.createElement(Highlight$1, _extends$1({}, defaultProps, {
    Prism: prism,
    code: code // @ts-ignore
    ,
    ...
    className: className,
    style: style
  }, tokens.map((line, index) => /*#__PURE__*/React__default.createElement(FrameCodeSnippetLine, _extends$1({}, getLineProps({
    line,
    key: index
  }), {
    frame: frame,
...
function ErrorCard() {
  ...
  return /*#__PURE__*/React__default.createElement("section", {
    className: "grid grid-cols-1 lg:flex items-stretch ~bg-white shadow-lg"
    ...
    className: "group h-10 px-4 items-center flex gap-3 rounded-sm ~bg-gray-500/5"
...
function DebugTabs({
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    className: "-my-5 flex justify-start items-center rounded-full shadow-lg bg-indigo-400 text-white space-x-px"
...
function DebugItem({
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    className: "py-10 px-6 sm:px-10 min-w-0 overflow-hidden grid grid-cols-1 gap-2"
  }, /*#__PURE__*/React__default.createElement("div", {
