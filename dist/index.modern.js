...
import css$1 from 'react-syntax-highlighter/dist/esm/languages/hljs/css';
...
const proto = Object.defineProperties(() => {}, _extends({}, styles, {
  level: {
    enumerable: true,
...
const configUtils = {
  ...
  breakpoints(screens) {
    return Object.keys(screens).filter(key => typeof screens[key] === 'string').reduce((breakpoints, key) => _extends({}, breakpoints, {
...
function mergeThemes(themes) {
  return _extends({}, themes.reduce((merged, theme) => (defaults_1).defaults(merged, theme), {}), {
...
function mergeExtensions(_ref) {
  let {
    extend
      ...
      theme = _objectWithoutPropertiesLoose(_ref, _excluded$5);
...
} = resolveConfig_1(defaultConfig_1);
const light = {
  hljs: {},
  'hljs-subst': {
    color: colors$1.gray['800']
  },
  'hljs-comment': {
  ...
  'hljs-type': {
    color: colors$1.emerald['800']
  },
  'hljs-string': {
    color: colors$1.red['700']
  },
  'hljs-number': {
    color: colors$1.emerald['800']
  },
  ...
  'hljs-literal': {
    color: colors$1.violet['700']
  },
  'hljs-built_in': {
    color: colors$1.indigo['400']
  },
  'hljs-bullet': {
    color: colors$1.indigo['400']
  },
...
Light.registerLanguage('php-template', phpTemplate);
Light.registerLanguage('blade', blade);
Light.registerLanguage('xml', xml);
Light.registerLanguage('css', css$1);
Light.registerLanguage('javascript', javascript);
Light.registerLanguage('handlebars', handlebars);
function FrameCodeSnippet({
  ...
  }, /*#__PURE__*/React__default.createElement(Light, {
